...
### 코드 구조
<img width="471" alt="image" src="https://github.com/zihooy/Java-AStar-Algorithm/assets/101122651/f6db92ee-7171-4ae3-b98a-f4b564f23b52">
...
### 실행시 유의 사항
- resources 폴더 안에 `application.yml` 파일을 제작하여 다음과 같은 내용을 추가해야 함
```
kakao:
  rest:
    api:
